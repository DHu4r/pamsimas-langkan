        ...
        <div class="flex flex-wrap mt-3 gap-y-4">
                ...
                <div class="w-11/12 h-40 bg-[#18A3B8] rounded-xl shadow mx-auto">
                    <div class="relative h-9/12 flex flex-col justify-between">
                        ...
                        <div class="p-2 relative z-10">
                            <h1 class="ps-2 mt-2 w-8/12 text-white font-extrabold text-2xl">{{ $total_penggunaan_air }} M <sup>3</sup></h1>
                        </div>
                        <div class="text-white p-2 font-semibold">Penggunaan Air Tercatat</div>
                    </div>
            ...
            <div class="w-full md:w-6/12 lg:w-3/12">
                <div class="w-11/12 h-40 bg-[#27A746] rounded-xl shadow mx-auto">
                    <div class="relative h-9/12 flex flex-col justify-between">
                    <img src="{{ asset('img/tagihan.png') }}" class="absolute inset-0 w-20 opacity-30 z-0 ms-auto mt-2 mr-2">
                        <div class="p-2 relative z-10">
                            <h1 class="ps-2 w-8/12 text-white font-extrabold text-md mt-2">Rp. {{ number_format($total_terbayar, 0, ',', '.') }}</h1>
                        </div>
                        <div class="text-white p-2 font-semibold">Tagihan Air Terbayar</div>
                    </div>
                    <a href="/tagihan_air">
            ...
            <div class="w-full md:w-6/12 lg:w-3/12">
                <div class="w-11/12 h-40 bg-[#FEC009] rounded-xl shadow mx-auto">
                    <div class="relative h-9/12 flex flex-col justify-between">
                        ...
                        <div class="p-2 relative z-10">
                            <h1 class="ps-2 w-8/12 text-white font-extrabold text-4xl mt-2">{{ $meter_akhir }}</h1>
                        </div>
                        <div class="text-white p-2 font-semibold">Angka Meteran Air Terakhir</div>
                    </div>
                    <a href="/penggunaan_air">
            ...
            <div class="w-full md:w-6/12 lg:w-3/12">
                <div class="w-11/12 h-40 bg-[#C7313E] rounded-xl shadow mx-auto">
                    ...
                    <div class="relative h-9/12 flex flex-col justify-between">
                        <img src="{{ asset('img/tagihan.png') }}" class="absolute inset-0 w-20 opacity-30 z-0 ms-auto mt-2 mr-2">
                        <div class="p-2 relative z-10">
                            <h1 class="ps-2 w-8/12 text-white font-extrabold text-xl mt-2">Rp. {{ number_format($total_belum_bayar, 0, ',', '.') }}</h1>
                        </div>
                        <div class="text-white p-2 font-semibold">Tagihan Air Belum Terbayar</div>
                    </div>
                    <a href="/tagihan_air">
