                ...
                <div class="w-11/12 h-40 bg-[#18A3B8] rounded-xl shadow mx-auto">
                    <div class="relative h-9/12 flex flex-col justify-between">
                        ...
                        <div class="p-2 relative z-10">
                            <h1 class="ps-2 mt-2 w-8/12 text-white font-extrabold text-xl">Rp. {{ number_format($total_nominal, 0, ",", ".") }}</h1>
                        </div>
                        <div class="text-white p-2 font-semibold">Tagihan Air Terbayar Bulan Ini</div>
                    </div>
                    <a href="/tagihan_air">
            ...
            <div class="w-full md:w-6/12 lg:w-3/12">
                <div class="w-11/12 h-40 bg-[#FEC009] rounded-xl shadow mx-auto">
                    <div class="relative h-9/12 flex flex-col justify-between">
                        ...
                        <div class="p-2 relative z-10">
                            <h1 class="ps-2 w-8/12 text-white font-extrabold text-4xl mt-2">{{ $pembayaran_saya }}</h1>
                        </div>
                        <div class="text-white p-2 font-semibold">History Pembayaran Saya</div>
                    </div>
                    <a href="/pembayaran">
            ...
            <div class="w-full md:w-6/12 lg:w-3/12">
                <div class="w-11/12 h-40 bg-[#C7313E] rounded-xl shadow mx-auto">
                    <div class="relative h-9/12 flex flex-col justify-between">
                        <img src="{{ asset('img/tagihan.png') }}" class="absolute inset-0 w-20 opacity-30 z-0 ms-auto mt-2 mr-2">
                        <div class="p-2 relative z-10">
                            <h1 class="ps-2 w-8/12 text-white font-extrabold text-xl mt-2">{{ $air_belum_lunas_periode_ini }}</h1>
                        </div>
                        <div class="text-white p-2 font-semibold">Tagihan Air Belum Terbayar Bulan Ini</div>
                    </div>
                    <a href="/tagihan_air">
