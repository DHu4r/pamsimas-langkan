<x-layout :tittle="$tittle">
    @if (auth()->check())
        <div class="bg-gray-100 shadow w-full py-2 px-2 rounded-2xl">
            <h1 class="ps-10 font-semibold text-slate-900">Selamat Datang {{ auth()->user()->nama }}</h1>
        </div>
    @endif
    <div class="w-full py-2 px-2 mt-5">
        <h2>Informasi Periode Bulan ini</h2>
            ...
            <div class="w-full md:w-6/12 lg:w-3/12">
                <div class="w-11/12 h-40 bg-[#27A746] rounded-xl shadow mx-auto">
                    ...
                    <img src="{{ asset('img/tagihan.png') }}" class="absolute inset-0 w-20 opacity-30 z-0 ms-auto mt-2 mr-2">
                        <div class="p-2 relative z-10">
                            <h1 class="ps-2 w-8/12 text-white font-extrabold text-4xl mt-2">Rp. {{ number_format($total_nominal, 0, ",", ".") }}</h1> 
                        </div>
            ...
            <div class="w-full md:w-6/12 lg:w-3/12">
                <div class="w-11/12 h-40 bg-[#FEC009] rounded-xl shadow mx-auto">
                    <div class="relative h-9/12 flex flex-col justify-between">
                        ...
                        <div class="text-white p-2 font-semibold">Pelanggan Aktif</div>
                    </div>
                    <a href="/pelanggan">
            ...
            <div class="w-full md:w-6/12 lg:w-3/12">
                <div class="w-11/12 h-40 bg-[#C7313E] rounded-xl shadow mx-auto">
                    <div class="relative h-9/12 flex flex-col justify-between">
                        <img src="{{ asset('img/tagihan.png') }}" class="absolute inset-0 w-20 opacity-30 z-0 ms-auto mt-2 mr-2">
                        <div class="p-2 relative z-10">
                            <h1 class="ps-2 w-8/12 text-white font-extrabold text-4xl mt-2">Rp. {{ number_format($air_belum_lunas_periode_ini, 0,",", ".") }}<h1>
                        </div>
